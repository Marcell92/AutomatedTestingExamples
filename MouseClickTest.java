...
public class MouseClickTest {
	...
	public void firstTest() throws InterruptedException {
		...
		action.sendKeys(Keys.TAB).perform();
		action.sendKeys("jhgfawddfkjghsdfslkdajfhjhfglidajhgsdfsdflkdajfhgl").perform();

		// Do something with random for these 2

		action.sendKeys(Keys.TAB).perform();
		action.sendKeys("afesdfwwdra@swdgfrwejhrsfdsf.com").perform();
		...
		// still resolves in an error but maybe that is due to scrrensho thelper method
		// possibly due to lack of assert statement within thi stest
